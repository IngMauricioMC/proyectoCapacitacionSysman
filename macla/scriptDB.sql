...
INSERT INTO servicios(nombre, descripcion, imagen, id_estado) VALUES
 ("Confecciones en General", "Se hace confección de todo tipo de ropa (Formal, Deportiva, De Gala, Uniformes, etc...) para niños, niñas, jóvenes, hombre y mujeres. Se hace sobre medida y por talla.", "src/pictures/confeccion1.png", 5),
 ("Arreglos en General", "Se arregla todo tipo de ropa y al gusto del cliente", "src/pictures/arreglos1.jpg", 5);
